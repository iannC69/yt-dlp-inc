          ...
          <div className="sp-footer-inner">
            <div className="sp-footer-top">
              ...
              <div className="sp-footer-badges">
                <span className="sp-footer-badge sp-footer-badge--green">
                  <HardDrive size={9} /> yt-dlp
                </span>
                <span className="sp-footer-badge sp-footer-badge--green">
                  <Music size={9} /> Spotify API
                </span>
                <span className="sp-footer-badge sp-footer-badge--dim">
                  <CheckCircle2 size={9} /> Lossless Quality
                </span>
                <span className="sp-footer-badge sp-footer-badge--dim">
                  <HardDrive size={9} /> ID3 Tags
                </span>
              </div>
            </div>
